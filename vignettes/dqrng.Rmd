...
You may access the global pointer to the RNG engine using `dqrng::get_rng()`;
however, be careful to **not** explicitly modify or delete the associated raw
pointer (or wrap it in a smart pointer).
...
// [[Rcpp::export]]
Rcpp::NumericMatrix multiple_distributions(int n) {
  Rcpp::XPtr<dqrng::random_64bit_generator> rng = dqrng::get_rng();
  // distributions with default parameters
  binomial bernoulli;
  normal normal;
  Rcpp::NumericMatrix out(n, 3);
