...
* **Threefry**  
The 64 bit version of the 20 rounds Threefry engine [@salmon2011] as provided by the package 'sitmo'.
...
This is quite fast since `boost::random::normal_distribution` uses the fast Ziggurat algorithm [@marsaglia2000]. 
