...
In this case, the alias method [@walker1977; @vose1991] is being used.

The final case would be high sampling rates without replacement.
For this Algorithm A from @efraimidis2006 in the exponential formulation from @R-wrswoR has been implemented.
