...
* Allow uniform and normal distributions to be registered as user-defined RNG within R. This happens automatically if the option `dqrng.register_methods` is set to `TRUE`.
